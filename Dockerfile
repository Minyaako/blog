...
USER node
RUN --mount=type=bind,from=build,source=/app/scripts/runtime-smoke.mjs,target=/tmp/runtime-smoke.mjs \
  node /tmp/runtime-smoke.mjs
EXPOSE 8080
