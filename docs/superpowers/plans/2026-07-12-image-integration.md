...
- [x] **Step 1: Record local source hashes and dimensions**
...
- [x] **Step 2: Create the private remote collection structure**
...
- [x] **Step 3: Upload sources under descriptive names**
...
- [x] **Step 4: Verify the remote copies before removing local sources**
...
- [x] **Step 5: Preserve the local inputs until WebP derivation is complete**
...
- [x] **Step 1: Convert all PNG sources with libwebp**
...
Execution note: the installed FFmpeg build did not include a WebP encoder. The verified fallback used Pillow 12.2.0 with WebP support (`quality=82`, `method=6`, `exact=True`), which uses the local libwebp codec and preserves the same dimensions and aspect ratios.
...
- [x] **Step 3: Remove the temporary local PNG directory**
...
- [x] **Step 4: Commit the delivery assets**
...
- [x] **Step 1: Write failing home rotation tests**
...
- [x] **Step 2: Run the focused tests to verify red state**
...
- [x] **Step 3: Implement the slides and timer**
...
- [x] **Step 4: Replace the profile image path**
...
- [x] **Step 5: Verify and commit home behavior**
...
- [x] **Step 1: Write failing article-header tests**
...
- [x] **Step 2: Run focused tests to verify red state**
...
- [x] **Step 3: Update frontmatter only**
...
- [x] **Step 4: Render the sensitive header behind the warning gate**
...
- [x] **Step 5: Verify safety and commit article mapping**
...
- [x] **Step 1: Run the complete non-visual gate**
...
- [x] **Step 2: Update and inspect visual baselines**
...
- [x] **Step 4: Commit acceptance evidence and baselines**
...
- [x] **Step 5: Ensure the local development server is available**
